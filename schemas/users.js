...
const {inventrySchema} = require('./inventrySchema');
...
try {
    moongoose.connect(DB_URL + DB_NAME, function(error) {
...
module.exports.inventry = moongoose.model('inventry', inventrySchema);